...
@NodeInfo(shortName = "<")
public class LamaLessExpressionNode extends LamaExpressionBaseNode {
	@Child 
	private LamaExpressionBaseNode leftNode;
    @Child 
    private LamaExpressionBaseNode rightNode;
    
    public LamaLessExpressionNode(LamaExpressionBaseNode leftNode, LamaExpressionBaseNode rightNode) {
