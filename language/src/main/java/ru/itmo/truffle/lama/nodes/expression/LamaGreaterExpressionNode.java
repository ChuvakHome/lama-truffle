...
@NodeInfo(shortName = ">")
public class LamaGreaterExpressionNode extends LamaExpressionBaseNode {
	@Child 
	private LamaExpressionBaseNode leftNode;
    @Child 
    private LamaExpressionBaseNode rightNode;
    
    public LamaGreaterExpressionNode(LamaExpressionBaseNode leftNode, LamaExpressionBaseNode rightNode) {
