...
@NodeInfo(shortName = ">=")
public class LamaGreaterOrEqualExpressionNode extends LamaExpressionBaseNode {
	@Child 
	private LamaExpressionBaseNode leftNode;
    @Child 
    private LamaExpressionBaseNode rightNode;
    
    public LamaGreaterOrEqualExpressionNode(LamaExpressionBaseNode leftNode, LamaExpressionBaseNode rightNode) {
