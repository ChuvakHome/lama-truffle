...
@NodeInfo(shortName = "==")
public class LamaEqualExpressionNode extends LamaExpressionBaseNode {
	@Child 
	private LamaExpressionBaseNode leftNode;
    @Child 
    private LamaExpressionBaseNode rightNode;
    
    public LamaEqualExpressionNode(LamaExpressionBaseNode leftNode, LamaExpressionBaseNode rightNode) {
